...
[Windows 版本(要求XP SP3以上)] (https://raw.githubusercontent.com/getlantern/lantern-binaries/master/lantern-installer-3.0.4.exe)      [备用地址] (https://s3.amazonaws.com/lantern/lantern-installer-3.0.5.exe)  

[安卓版(要求4.1以上)] (https://raw.githubusercontent.com/getlantern/lantern-binaries/master/lantern-installer-3.0.4.apk)               [备用地址] (https://s3.amazonaws.com/lantern/lantern-installer-3.0.5.apk) **请勿使用UC浏览器点击下载，会被替换成假的有广告的版本**  [Google Play下载](https://play.google.com/store/apps/details?id=org.getlantern.lantern)

[macOS (10.7及以上)] (https://raw.githubusercontent.com/getlantern/lantern-binaries/master/lantern-installer-3.0.4.dmg)              [备用地址] (https://s3.amazonaws.com/lantern/lantern-installer-3.0.5.dmg) 
